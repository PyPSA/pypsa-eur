...
test:
	...
	snakemake resources/test/maps/power-network-s-all.pdf --configfile config/test/config.tyndp.yaml
...
clean-tests:
	...
	snakemake resources/test/maps/power-network-s-all.pdf --configfile config/test/config.tyndp.yaml --delete-all-output
