...
def steel_preprocessing(excel_dir, scenario, config):
    eaf_prod = pd.read_excel(
        excel_dir + scenario + ".xlsx", sheet_name="EAF_Prod", index_col="Bus"
    )
    bof_prod = pd.read_excel(
        excel_dir + scenario + ".xlsx", sheet_name="BOF_Prod", index_col="Bus"
    )
    ng_eaf_prod = pd.read_excel(
        excel_dir + scenario + ".xlsx", sheet_name="NG_EAF", index_col="Bus"
    )
    h2_eaf_prod = pd.read_excel(
        excel_dir + scenario + ".xlsx", sheet_name="H2_EAF", index_col="Bus"
    )
    ...
    steel_emis = pd.read_excel(
        excel_dir + scenario + ".xlsx", sheet_name="Steel_Proc_Emis", index_col="Bus"
    )
...
for scenario in scenarios:
    steel_prod, green_share, steel_emis = steel_preprocessing(
        excel_dir, scenario, config
    )
