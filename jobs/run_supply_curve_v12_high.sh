#!/bin/bash
# =============================================================================
# run_supply_curve_v12_high.sh
# Submit one LSF job per supply curve scenario — v10 HIGH B-bracket (hiB, ×0.52 net-heat).
# Results go to: results/supply_curve_v12/supply_curve_v12_high/<scenario>/
#
# Usage (from repo root):
#   bash jobs/run_supply_curve_v12_high.sh           # submit all scenarios
#   bash jobs/run_supply_curve_v12_high.sh S01 S03   # submit specific scenarios by prefix
#
# Flags:
...
CONFIG_DIR="$REPO_ROOT/config/Myruns/supply_curve_v12/supply_curve_v12_high"
...
echo "  bjobs -J 'v12h-*'"
echo ""
echo "Results: results/supply_curve_v12/supply_curve_v12_high/"
echo "Logs:    $LOG_DIR"
