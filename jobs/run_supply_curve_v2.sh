...
#!/bin/bash
# =============================================================================
# run_supply_curve_v2.sh
# Submit one LSF job per supply curve V2 scenario (S00 through S10).
...
#   bash run_supply_curve_v2.sh           # submit all scenarios
#   bash run_supply_curve_v2.sh S00 S01   # submit specific scenarios by prefix
#
# Flags:
...
CONFIG_DIR="$REPO_ROOT/config/Myruns/supply_curve_v2"
LOG_DIR="$REPO_ROOT/logs/supply_curve_v2"
mkdir -p "$LOG_DIR"
