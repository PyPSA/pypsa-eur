#!/bin/bash
# =============================================================================
# run_supply_curve_v11.sh
# Submit one LSF job per supply curve scenario — v11 medium (no CCS growth caps).
# Results go to: results/supply_curve_v11/<scenario>/
#
# Usage (from repo root):
#   bash jobs/run_supply_curve_v11.sh           # submit all scenarios
#   bash jobs/run_supply_curve_v11.sh S01 S03   # submit specific scenarios by prefix
#
# Flags:
...
CONFIG_DIR="$REPO_ROOT/config/Myruns/supply_curve_v11"
LOG_DIR="$REPO_ROOT/logs/supply_curve_v11"
mkdir -p "$LOG_DIR"
...
echo "  bjobs -J 'v11-*'"
echo ""
echo "Results: results/supply_curve_v11/"
echo "Logs:    $LOG_DIR"
