...
#   bash run_supply_curve_v4.sh           # submit all scenarios
#   bash run_supply_curve_v4.sh S00 S01   # submit specific scenarios by prefix
#
# Flags:
...
CONFIG_DIR="$REPO_ROOT/config/Myruns/supply_curve_v4"
LOG_DIR="$REPO_ROOT/logs/supply_curve_v4"
mkdir -p "$LOG_DIR"
...
for cfg in "${CONFIGS[@]}"; do
    ...
    job_name="sct-v4-${scenario_id}"                       # e.g. sct-S01-050eur
