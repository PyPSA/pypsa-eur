#!/bin/bash
# =============================================================================
# run_scenario1_high.sh
# Submit one LSF job per supply curve scenario — Scenario 1 (deployment response), HIGH CDR cost.
# (formerly run_supply_curve_v12_high.sh; v10 HIGH B-bracket (hiB, ×0.52 net-heat).)
# Results go to: results/supply_curve_v12/supply_curve_v12_high/<scenario>/
#
# Usage (from repo root):
#   bash jobs/run_scenario1_high.sh           # submit all scenarios
#   bash jobs/run_scenario1_high.sh S01 S03   # submit specific scenarios by prefix
#
# Flags:
