...
if __name__ == "__main__":
    ...
    if q2q_transform["enable"]:
        ...
        if not q2q_filename:
            logger.info(
                f"########## [PyPSA-Spain] <build_renewable_profiles.py> WARNING: No q2q transform available for {technology}.."
            )

        ##### Aply q2q transform
        else:
            logger.info(
                f'########## [PyPSA-Spain] <build_renewable_profiles.py> INFO: Applying q2q transform "{q2q_filename}" to {technology}..'
            )
        ...
        print(
            f"########## [PyPSA-Spain] <build_renewable_profiles.py> INFO: Ommitting q2q transform for {technology}.."
        )
