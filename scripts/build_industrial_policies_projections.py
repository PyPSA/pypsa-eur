...
def calculate_industrial_production(years, scenarios, sector, base_year, base_prod, end_year, end_prod):
    """
    ...
    cols = ['year', 'sector'] + [col for col in production.columns if col not in ['year', 'sector']]
...
if __name__ == "__main__":
    ...
    # Save to CSV
    industry_prod_scenarios.to_csv(snakemake.output.industry_prod_scenarios, index=False)