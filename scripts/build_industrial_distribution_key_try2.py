...
def build_nodal_distribution_key(
    ...
    for country in countries:
        ...
        if not capacities.empty:
            ...
            start_dates = facilities.loc[capacities.index, "Cement"].dropna()
    ...
    return keys, steel_capacities, steel_start_dates, cement_capacities, cement_start_dates, chemicals_capacities, chemicals_start_dates, capacities, start_dates 
...
if __name__ == "__main__":
    ...
    keys, steel_capacities, steel_start_dates, cement_capacities, cement_start_dates, chemicals_capacities, chemicals_start_dates, capacities, start_dates= build_nodal_distribution_key(
        hotmaps, steel_gem, cement_sfi, chemicals_ecm, ammonia, cement, refineries, regions, countries
    )
