...
class IndustryConfig(ConfigModel):
    ...
    H2_DRI: float = Field(
        1.7,
        description="The hydrogen consumption in Direct Reduced Iron (DRI) Mwh_H2 LHV/ton_Steel from 51kgH2/tSt in [Vogl et al (2018)](https://doi.org/10.1016/j.jclepro.2018.08.279).",
    )
    elec_DRI: float = Field(
        0.322,
        description="The electricity consumed in Direct Reduced Iron (DRI) shaft. From [HYBRIT brochure](https://ssabwebsitecdn.azureedge.net/-/media/hybrit/files/hybrit_brochure.pdf).",
    )
    ...
    MWh_CH4_per_tNH3_SMR: float = Field(
        10.8,
        description="The energy amount of methane needed to produce a ton of ammonia using steam methane reforming (SMR). Value derived from 2012's demand from [Center for European Policy Studies (2008)](https://ec.europa.eu/docsroom/documents/4165/attachments/1/translations/en/renditions/pdf).",
    )
    ...
    MWh_H2_per_tNH3_electrolysis: float = Field(
        5.93,
        description="The energy amount of hydrogen needed to produce a ton of ammonia using Haber–Bosch process. From [Wang et al (2018)](https://doi.org/10.1016/j.joule.2018.04.017), Base value assumed around 0.197 tH2/tHN3 (>3/17 since some H2 lost and used for energy).",
    )
    MWh_elec_per_tNH3_electrolysis: float = Field(
        0.2473,
        description="The energy amount of electricity needed to produce a ton of ammonia using Haber–Bosch process. From [Wang et al (2018)](https://doi.org/10.1016/j.joule.2018.04.017), Table 13 (air separation and HB).",
    )
    ...
    HVC_production_today: float = Field(
        52.0,
        description="The amount of high value chemicals (HVC) produced. This includes ethylene, propylene and BTX. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), Figure 16, page 107.",
    )
    MWh_elec_per_tHVC_mechanical_recycling: float = Field(
        0.547,
        description="The energy amount of electricity needed to produce a ton of high value chemical (HVC) using mechanical recycling. From SI of [Meys et al (2020)](https://doi.org/10.1016/j.resconrec.2020.105010), Table S5, for HDPE, PP, PS, PET. LDPE would be 0.756.",
    )
    MWh_elec_per_tHVC_chemical_recycling: float = Field(
        6.9,
        description="The energy amount of electricity needed to produce a ton of high value chemical (HVC) using chemical recycling. The default value is based on pyrolysis and electric steam cracking. From [Material Economics (2019)](https://materialeconomics.com/latest-updates/industrial-transformation-2050), page 125.",
    )
    chlorine_production_today: float = Field(
        9.58,
        description="The amount of chlorine produced. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), Table 7, page 43.",
    )
    MWh_elec_per_tCl: float = Field(
        3.6,
        description="The energy amount of electricity needed to produce a ton of chlorine. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), Table 6 page 43.",
    )
    ...
    methanol_production_today: float = Field(
        1.5,
        description="The amount of methanol produced. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), page 62.",
    )
    MWh_elec_per_tMeOH: float = Field(
        0.167,
        description="The energy amount of electricity needed to produce a ton of methanol. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), Table 14, page 65.",
    )
    MWh_CH4_per_tMeOH: float = Field(
        10.25,
        description="The energy amount of methane needed to produce a ton of methanol. From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), Table 14, page 65.",
    )
    MWh_MeOH_per_tMeOH: float = Field(
        5.528,
        description="The energy amount per ton of methanol (LHV). From [DECHEMA (2017)](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry-p-20002750.pdf), page 74.",
    )
    ...
    reference_year: int = Field(
        2019,
        description="The year used as the baseline for industrial energy demand and production. Data extracted from [JRC-IDEES 2015](https://data.jrc.ec.europa.eu/dataset/jrc-10110-10001).",
    )
