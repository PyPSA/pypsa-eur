...
* Fixed a bug where custom power plants added through `data/custom_powerplants.csv` were attatched to the wrong bus if they had non-unique ids (`#131 <https://github.com/PyPSA/pypsa-eur/pull/131>`_).
