...
Missing or too coarsely aggregated data in the JRC-IDEES database is supplemented with additional datasets: [Eurostat energy balances](https://ec.europa.eu/eurostat/web/energy/database), [United States](https://www.usgs.gov/media/files/nitrogen-2017-xlsx),  [Geological Survey](https://www.usgs.gov/media/files/nitrogen-2017-xlsx) for ammonia production, [DECHEMA](https://dechema.de/dechema_media/Downloads/Positionspapiere/Technology_study_Low_carbon_energy_and_feedstock_for_the_European_chemical_industry.pdf) for methanol and chlorine, and [national statistics from Switzerland](https://www.bfe.admin.ch/de/statistiken).
