...
<!-- Upcoming Release -->
<!-- ================= -->
* The `plotting:` configuration block is now covered by the Pydantic config validation, like all other top-level config sections.
  `config/plotting.default.yaml` is a generated, generated by `pixi run generate-config`.
  No default values have been changed; a missing configuration section `heat_source_map` has been added.
  Plotting configuration values for `balance_map`/`balance_map_interactive` rendered as floats rather than strings.
