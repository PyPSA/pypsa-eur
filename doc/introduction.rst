...
.. note::
    ...
    ``snakemake --dag results/test-elec/networks/solved_2050.nc --configfile config/test/config.electricity.yaml -F | sed -n "/digraph/,/}/p" | dot -Tpng -o doc/img/intro-workflow.png``
