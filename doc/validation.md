...
The setup uses monthly varying fuel prices for gas, lignite, coal and oil as well as CO2 prices, which are created by the script [build_monthly_prices][].
...
![Validation seasonal operation area](img/validation_seasonal_operation_area_elec_s_37_ec_lv1.0_Ept.png){width=100%}

![Validation production bar](img/validation_production_bar_elec_s_37_ec_lv1.0_Ept.png){width=100%}
