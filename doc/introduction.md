...
!!! note
    Find the introductory slides [here](https://docs.google.com/presentation/d/1s4xkeGfR_IqArmceRaYgZUl0UFLymGXwjz6SRWBtNnE/edit).
...
[Snakemake](https://snakemake.github.io/). In a nutshell, the `Snakefile`
...
[![Intro workflow](img/intro-workflow.svg)](img/intro-workflow.svg)
...
read carefully through the documentation of the [command line interface](https://snakemake.readthedocs.io/en/stable/executing/cli.html), noting the
...
like [Gurobi](http://www.gurobi.com/) or [CPLEX](https://www.ibm.com/analytics/cplex-optimizer) with more memory.
