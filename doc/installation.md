...
!!! tip
    You can also set up automatic shell activation in several popular editors (e.g. in [VSCode](https://pixi.sh/dev/integration/editor/vscode/) or [Zed](https://pixi.sh/dev/integration/editor/zed/)).
