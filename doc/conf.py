...
latex_documents = [
    (master_doc, "PyPSA-Eur.tex", u"PyPSA-Eur Documentation", u"author", "manual"),
]
...
man_pages = [(master_doc, "pypsa-eur", u"PyPSA-Eur Documentation", [author], 1)]
