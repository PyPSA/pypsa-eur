...
## Setup and Authentication {#oetc_setup}
...
2. **Configure OETC settings** in your configuration file (see [Configuration](#oetc_config)).

## Configuration {#oetc_config}
